...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MOUSE, ESC),U_LT(U_NAV, SPACE),U_LT(U_NUM, TAB),  U_LT(U_MEDIA, RET),U_LT(U_SYM, BSPC), U_LT(U_FUN, MINUS),U_NP,              U_NP
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             &kp LBRC,          &kp RBRC,          &kp PG_UP,         &kp HOME,          \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &kp GRAVE,         \
U_NA,              &kp RALT,          &u_to_U_SYM,       &u_to_U_NAV,       U_NA,              U_UND,             &kp LBKT,          &kp RBKT,          &kp PG_DN,         &kp END,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_PST,             U_CPY,             U_CUT,             U_NP,              U_NP
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MOUSE,     U_NA,              U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP
...
&kp C_PREV,        &kp C_VOL_UP,      &kp C_VOL_DN,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp RSHIFT,        &kp RCTRL,         &kp RALT,          &kp RGUI,          \
&u_bt_sel_3,       &u_bt_sel_2,       &u_bt_sel_1,       &u_bt_sel_0,       &u_out_tog,        U_NA,              &u_to_U_MEDIA,     &u_to_U_NUM,       &kp LALT,          U_NA,             \
U_NP,              U_NP,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,        U_NA,              &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp TAB,           &kp DOT,           U_NP,              U_NP
...
&kp F10,           &kp F1,            &kp F2,            &kp F3,            &kp PAUSE_BREAK,   U_NA,              &u_to_U_FUN,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
